...
from moss_ttsd.audio import trim_silence
from moss_ttsd.models.modeling_moss_ttsd import MossTTSDForCausalLM
...
class MossTTSDInferencer:
    ...
    def _load(self) -> None:
        ...
        if self.device == "auto":
            ...
            self._model = MossTTSDForCausalLM.from_pretrained(
